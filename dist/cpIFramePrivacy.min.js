 ...
 */
(function(window,document){function cpIFramePrivacy(){var _cpIFramePrivacy={};_cpIFramePrivacy.config={cookiesEnabled:!1,cookieDuration:1,};_cpIFramePrivacy.setCookieEnabled=function(value){_cpIFramePrivacy.config.cookiesEnabled=value};_cpIFramePrivacy.setCookieDuration=function(value){if(value<1){throw 'Do not set the Cookie-Duration to a value lower than 1. If you want to disable the cookie, please use setCookieEnabled(false)'}
_cpIFramePrivacy.config.cookieDuration=value};_cpIFramePrivacy.setCookie=function(name){var d=new Date();d.setTime(d.getTime()+24*60*60*1000*this.config.cookieDuration);document.cookie="cpIFramePrivacy_"+name+"=1;expires="+d.toGMTString()+";path=/"};_cpIFramePrivacy.checkCookie=function(name){var v=document.cookie.match("(^|;) ?"+"cpIFramePrivacy_"+name+"=([^;]*)(;|$)");return v?!0:!1};_cpIFramePrivacy.initIFrame=function(containerId){var containerElement=document.getElementById(containerId);if(containerElement===null){throw "No container element with #"+containerId+" found."}
